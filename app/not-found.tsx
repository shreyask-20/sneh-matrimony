  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white px-4 text-center dark:bg-slate-950">
      <div className="max-w-md">
        <h1 className="mb-2 text-6xl font-bold text-[#A0144D]">404</h1>
        ...
        <a
          href="/"
          className="inline-block rounded-lg bg-[#A0144D] px-6 py-3 text-white transition-colors hover:bg-[#A0144D]/90"
        >
          Go home
        </a>
      </div>
